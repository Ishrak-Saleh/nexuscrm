...
<div class="form-card">
    ...
    <form method="POST" action="{{ route('clients.update', $client) }}" class="edit-form">
        @csrf
        @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="textarea-wrapper">
                        <textarea name="address" 
                                  ...
                                  placeholder="Street, City, State, ZIP Code">{{ old('address', $client->address) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrapper">
                        <select name="status" 
                            ...
                            <option value="lead" {{ old('status', $client->status) == 'lead' ? 'selected' : '' }}>
                                Lead
                            </option>
...
/* Remove left padding when there's no icon */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show today's date as placeholder for date input
